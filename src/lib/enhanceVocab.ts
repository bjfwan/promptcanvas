export type SK = 'person'|'animal'|'landscape'|'object'|'abstract'|'architecture'|'food'|'general'
...
animal:{z:['柔和侧逆光勾勒毛发轮廓，眼神光清晰','头盔边缘有细窄轮廓光，面部毛发被柔光照亮','棚拍主光从左上方落下，毛发与服装阴影层次清楚'],e:['soft side-back light outlining fur, clear catchlights','thin rim light on helmet edge, soft fill on facial fur','studio key light from upper left, clear fur and suit shadow layers']},
...
animal:{z:['橘色毛发保留深浅层次，宇航服为低饱和奶白与银灰','暖橘毛色与冷灰月面形成对比，整体复古胶片调色','主色控制在橘色、月面灰、复古奶白三色'],e:['orange fur keeps tonal depth, spacesuit in desaturated cream white and silver gray','warm orange fur contrasts with cool gray lunar surface, vintage film grade','palette limited to orange, lunar gray, and vintage cream white']},
...
animal:{z:['主体居中略偏下，头盔与眼睛成为视觉焦点','竖版海报构图，上方预留标题空间，月面道具形成舞台纵深','低机位轻微仰拍，让动物主体显得像科幻主角'],e:['subject centered slightly low, helmet and eyes as focal point','vertical poster composition, title space above, lunar props create stage depth','slightly low camera angle making the animal feel like a sci-fi protagonist']},
...
animal:{z:['毛发分缕可见，胡须细节清晰，宇航服织物与金属扣具真实','透明头盔有轻微反射与折射，橘色毛发不过度塑料化','爪套、布料褶皱、胸前徽章和月尘颗粒都有可触质感'],e:['fur strands visible, whiskers sharp, believable spacesuit fabric and metal fasteners','transparent helmet has subtle reflection and refraction, orange fur avoids plastic look','gloves, fabric folds, chest badge, and moon dust feel tactile']},
...
animal:{z:['可爱但不幼稚，像复古科幻片里的正式角色','荒诞幽默与电影感并存，画面可信又有奇想','月球摄影棚带一点手工布景质感，复古、认真、轻微戏剧化'],e:['charming but not childish, like a serious character in a vintage sci-fi film','absurd humor and cinematic mood together, believable yet imaginative','moon studio has handmade set texture, vintage, earnest, lightly dramatic']},
...
animal:{z:['50mm 标准镜头，自然透视，焦点落在猫眼与头盔反光','35mm 电影海报视角，保留月球摄影棚环境信息','85mm 中焦浅景深，猫脸与宇航服胸前细节清晰'],e:['50mm standard lens, natural perspective, focus on cat eyes and helmet reflection','35mm cinematic poster view, keeping lunar studio context','85mm medium telephoto shallow depth, clear cat face and spacesuit chest detail']},
